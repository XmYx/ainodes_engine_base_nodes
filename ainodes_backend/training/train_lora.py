...
def generate_args(input_args=None):
    args = argparse.Namespace()

    default_model = "models/stable-diffusion-v1-5-cache"
    default_vae = "models/sd-vae-ft-mse-cache"
    default_images = "train/test"

    # Set default values
    args.pretrained_model_name_or_path = default_model
    args.pretrained_vae_name_or_path = default_vae
    args.revision = "fp16"
    args.tokenizer_name = None
    args.instance_data_dir = default_images
    args.class_data_dir = default_images
    args.instance_prompt = "test"
    args.class_prompt = "test"
    ...
    args.local_rank = -1
    args.resume_unet = None
    args.resume_text_encoder = None
    args.resize = True
    ...
    if args.with_prior_preservation:
        ...
        if args.class_data_dir is not None:
            print("Warning: You need not use --class_data_dir without --with_prior_preservation.")
        if args.class_prompt is not None:
            print("Warning: You need not use --class_prompt without --with_prior_preservation.")
