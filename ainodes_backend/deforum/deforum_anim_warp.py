...
def anim_frame_warp_2d(prev_img_cv2, angle, zoom , translation_x, translation_y, ):

    center = (prev_img_cv2.shape[1] // 2, prev_img_cv2.shape[0] // 2)
...
def anim_frame_warp_3d(device, prev_img_cv2, depth, translation_x, translation_y, translation_z, rotation_3d_x, rotation_3d_y, rotation_3d_z):
...
def transform_image_3d(device, prev_img_cv2, depth_tensor, rot_mat, translate, add_noise=False, noise_std=0.1):
    ...
    aspect_ratio = 1
    near, far, fov_deg = 1000, 10000, 90
