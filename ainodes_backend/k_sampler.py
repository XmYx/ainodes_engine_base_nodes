...
def common_ksampler(model, seed, steps, cfg, sampler_name, scheduler, positive, negative, latent, denoise=1.0, disable_noise=False, start_step=None, last_step=None, force_full_denoise=False, callback=None, noise_mask=None, device=None, *args, **kwargs):
    from comfy.sample import prepare_noise, sample
    ...
    if noise_mask is None and isinstance(latent, dict):
