...
from ai_nodes.ainodes_engine_base_nodes.torch_nodes.ksampler_node import get_fixed_seed
...
class KandinskySamplerNode(AiNode):
    ...
    custom_input_socket_name = ["DECODER", "COND","COND","EXEC"]

    def __init__(self, scene):
        super().__init__(scene, inputs=[4,3,3,1], outputs=[5,1])
